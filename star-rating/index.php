...
$sql = "SELECT * FROM products WHERE id = '$review_id'";
    ...
    $sql = "SELECT * FROM item_rating WHERE itemId = '$review_id'";
    $run_query = mysqli_query($conn,$sql);
    $count = mysqli_num_rows($run_query);
    if($count > 0){
	...
	<div id="ratingDetails"> 		
		...
		<div class="row">
			<div class="col-sm-7">
				...
				$ratinguery = "SELECT ratingId, itemId, userId, ratingNumber, title, comments, created, modified FROM item_rating WHERE itemId = '$review_id'";
				...
				?>				
					<div class="row">
						<div class="col-sm-3">
							<img src="image/avater.png" class="img-rounded img-responsive">
							<div class="review-block-name">By <a href="#"><?php echo  $_SESSION['u_first'];?></a></div>
