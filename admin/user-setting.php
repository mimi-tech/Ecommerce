        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a class="active" href="settings.php" style="background:#e17339;"><i class="fa fa-dashboard"></i>User Dashboard</a>
                    </li>
                ...
                <div class="col-md-12">
					...
					<div class="panel-body">
						...
						if(isset($_POST['in']))
						{
							...
							$newsql ="Insert into user (email,password,join_date) values ('$newus','$hashed', CURRENT_TIMESTAMP)";
