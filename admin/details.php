        ...
        <div id="page-wrapper">
            <div id="page-inner">
                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    <legend class="text-center">Items Ordered</legend>
                                    <thead>
                                        <tr>
               ...
               $oid = $_GET['oid'];
                ...
                <?php
                                     include 'db.php';   
									$tsql = "SELECT * FROM semi_posts WHERE post_id = '$oid'";
									$tre = mysqli_query($con,$tsql);
									while($trow=mysqli_fetch_array($tre) )
                                      //$tid = $row['post_id'];
									{
                        ...
                        <div class="col-sm-8">
                         <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
									...
									$tsql = "select * from posts WHERE id = '$oid'";
									$tre = mysqli_query($con,$tsql);
									while($trow=mysqli_fetch_array($tre) )
