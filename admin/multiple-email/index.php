			...
			<div class="table-responsive">
				...
				$sql =  "SELECT * FROM user_info ORDER BY user_id";
					...
					<tr>
						...
						<td>
						<button type="button" name="email_button" class="btn btn-info btn-xs email_button" id="'.$nums++.'" data-email="'.$row["email"].'" data-name="'.$row["first_name"].'" data-action="single">Send Single</button>
						</td>
					</tr>
					';
                                             }
