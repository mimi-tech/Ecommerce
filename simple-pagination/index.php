...
<title>phpcode : Demo Create Simple Pagination with PHP and MySQL</title>

<?php include('container.php');?>

<div class="container">
	<h2>
	Simple Pagination with PHP and MySQL</h2>		
	...
	$totalEmpSQL = "SELECT * FROM products";
	...
	$empSQL = "SELECT title,price
	FROM `products` LIMIT $startFrom, $showRecordPerPage";
